...
class StoresoalRequestModel {
  ...
  factory StoresoalRequestModel.fromJson(String str) =>
      StoresoalRequestModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory StoresoalRequestModel.fromMap(Map<String, dynamic> json) =>
      StoresoalRequestModel(
