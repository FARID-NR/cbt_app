...
class GetSoalResponseModel {
    ...
    factory GetSoalResponseModel.fromJson(String str) => GetSoalResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetSoalResponseModel.fromMap(Map<String, dynamic> json) => GetSoalResponseModel(
