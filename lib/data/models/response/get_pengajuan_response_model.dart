...
class PengajuanResponseModel {
  ...
  factory PengajuanResponseModel.fromJson(String str) =>
      PengajuanResponseModel.fromMap(json.decode(str));
...
class Data {
  ...
  factory Data.fromMap(Map<String, dynamic> json) => Data(
        ...
        mahasiswa: List<Mahasiswa>.from(
            json["mahasiswa"].map((x) => Mahasiswa.fromMap(x))),
