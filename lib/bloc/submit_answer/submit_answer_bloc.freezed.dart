...
mixin _$SubmitAnswerEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SubmitRequestModel requestModel, String matkulId,
            String soalId, String userId, Map<String, dynamic> selectedAnswer)
        submit,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(SubmitRequestModel requestModel, String matkulId,
            String soalId, String userId, Map<String, dynamic> selectedAnswer)?
        submit,
  }) =>
      throw _privateConstructorUsedError;
...
class _$StartedImpl implements _Started {
  ...
  @override
  String toString() {
    return 'SubmitAnswerEvent.started()';
  }
...
abstract class _$$SubmitImplCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {SubmitRequestModel requestModel,
      String matkulId,
      String soalId,
      String userId,
...
class __$$SubmitImplCopyWithImpl<$Res>
    extends _$SubmitAnswerEventCopyWithImpl<$Res, _$SubmitImpl>
...
class _$SubmitImpl implements _Submit {
  const _$SubmitImpl(this.requestModel, this.matkulId, this.soalId, this.userId,
  ...
  @override
  final String userId;
  final Map<String, dynamic> _selectedAnswer;
  @override
  Map<String, dynamic> get selectedAnswer {
    if (_selectedAnswer is EqualUnmodifiableMapView) return _selectedAnswer;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_selectedAnswer);
  }

  @override
  String toString() {
    return 'SubmitAnswerEvent.submit(requestModel: $requestModel, matkulId: $matkulId, soalId: $soalId, userId: $userId, selectedAnswer: $selectedAnswer)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, requestModel, matkulId, soalId,
      userId, const DeepCollectionEquality().hash(_selectedAnswer));
  ...
  TResult when<TResult extends Object?>({
    ...
    return submit(requestModel, matkulId, soalId, userId, selectedAnswer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return submit?.call(requestModel, matkulId, soalId, userId, selectedAnswer);
  }
...
abstract class _Submit implements SubmitAnswerEvent {
  const factory _Submit(
      final SubmitRequestModel requestModel,
      final String matkulId,
      final String soalId,
      final String userId,
      final Map<String, dynamic> selectedAnswer) = _$SubmitImpl;

  SubmitRequestModel get requestModel;
  String get matkulId;
  String get soalId;
  String get userId;
  Map<String, dynamic> get selectedAnswer;
...
mixin _$SubmitAnswerState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SubmitResponseModel data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(SubmitResponseModel data)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({SubmitResponseModel data});
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  final SubmitResponseModel data;

  @override
  String toString() {
    return 'SubmitAnswerState.loaded(data: $data)';
  }
...
abstract class _Loaded implements SubmitAnswerState {
  const factory _Loaded(final SubmitResponseModel data) = _$LoadedImpl;

  SubmitResponseModel get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'SubmitAnswerState.error(message: $message)';
  }
